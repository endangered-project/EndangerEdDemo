...
namespace EndangerEdDemo.Game.Graphics;

/// <summary>
/// The visualizer that's binded to the track. Get from the maisim project.
/// </summary>
public partial class AudioVisualizer : Drawable
{
    ...
    private class VisualizationDrawNode : DrawNode
    {
        ...
        public VisualizationDrawNode(AudioVisualizer source)
            : base(source)
        {
        }
