...
public partial class TestSceneSelectNameMicroGameScreen : EndangerEdDemoTestScene
{
    [Cached]
    ...
    public TestSceneSelectNameMicroGameScreen()
    {
        Add(mainScreenStack);
    }
    ...
    protected override void LoadAsyncComplete()
    {
        ...
        mainScreenStack.GameSessionScreenStack.MainScreenStack.Push(new SelectNameMicroGameScreen());
    }
}
